      ...
      <div className="search-wrapper">
        ...
        <div className="main-bg iframe-wrapper">
          <div className="c-card-interaction iframe-1st-compo">
            <iframe className="frame-customizing-interaction" style={{border:'0.5px solid lightgray'}} src="http://52.79.200.208/services/acetaminophen" height="100%" width="100%"></iframe>
          </div>
          <div className="iframe-compo-divide"> </div>
          <div className="c-card-interaction iframe-2nd-compo">
            <iframe className="frame-customizing-interaction" style={{border:'0.5px solid lightgray'}} src="http://52.79.200.208/services/escitalopram" height="100%" width="100%"></iframe>
          </div>
        </div>
        <div>
