    ...
    this.setState(
      {
        ...
        view
      } ,()=> console.log("after: ", this.state.clicked, this.state.view)
    )
    console.log("before: ", this.state.clicked, this.state.view)
  }
                          ...
                          <li id="top-list-process"> Data Types </li>
                            <ol style={{paddingLeft: '10px'}}>
                              <li id="top-list-process"> Structured Data </li>
                                <ol style={{paddingLeft: '10px'}}>
                                  <li style={{listStyle: 'circle', fontSize: '15px', display: this.state.view === 'view1' && this.state.clicked === false ? 'none':''}}> Drug Information Data  </li>
                            ...
                            <ol style={{paddingLeft: '18px'}}>
                              <li > Structured Data </li>
                                <ol style={{paddingLeft: '18px'}}>
                                  ...
                                  <li style={{listStyle: 'circle'}}> Real drug-drug-information occurrence data <button onClick={this.handleClick('view2')}> <Button /> </button></li>
                                </ol>
                            </ol>
                            <ol style={{paddingLeft: '18px'}}>
                              <li > Image Data </li>
